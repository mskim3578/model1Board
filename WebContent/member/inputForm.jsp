...
<script >
       function checkIt() {
        ...
        if(!userinput.passwd.value ) { alert("비밀번호를 입력하세요");
            return false;
        }
        ...
        if(!userinput.name.value) {        alert("name을 입력하세요");
            return false;        }
        if(!userinput.jumin1.value) {     alert("jumin1을 입력하세요");
            return false;        }
        if(!userinput.jumin2.value) {     alert("jumin2을 입력하세요");
            return false;        }
        if(!userinput.email.value) {      alert("email을 입력하세요");
            return false;
        } 
        if(userinput.idchk.value!="Y") { alert("id중복확인을 하세요");
        return false;
    } 
